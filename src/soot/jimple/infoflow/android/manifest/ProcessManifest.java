...
public class ProcessManifest {
	...
	/**
	 * No argument constructor to allow creation of subclasses without having this class perform any
	 * work (other constructors directly cause the manifest to be processed).
	 */
